...
public class ListSortClassSize {
...
allOf(withId(R.id.class_size_sort_button_main), withText("Sort By Class Size"),
childAtPosition(
childAtPosition(
withId(android.R.id.content),
0),
...
allOf(withId(R.id.recency_sort_button_main), withText("Sort By Recency"),
childAtPosition(
childAtPosition(
withId(android.R.id.content),
0),
...
withParent(withId(R.id.list_of_students)))),
isDisplayed()));
        textView2.check(matches(withText("Ted")));
        }
